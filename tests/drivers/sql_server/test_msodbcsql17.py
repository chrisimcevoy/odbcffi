...
class TestMsOdbcSql17(DriverTest):
    @property
    def expected_sql_get_info_w_return_values(self) -> Mapping[InfoType, Any]:
        return {
            ...
            InfoType.SQL_ASYNC_NOTIFICATION: ODBCError(
                ...
                sql_state="HY096",
                native_error=0,
                message_text="[Microsoft][ODBC Driver 17 for SQL Server]Invalid information type",
            ...
            InfoType.SQL_DRIVER_VER: "17.11.0001",
    ...
    def expected_sql_get_type_info_w_return_values(self) -> Mapping[SQLDataType, list[dict[str, Any]] | Exception]:
        return {
            ...
            SQLDataType.SQL_SS_TABLE: ODBCError(
                ...
                native_error=0,
                return_code=SQLReturn.SQL_ERROR,
                message_text="[Microsoft][ODBC Driver 17 for SQL Server]Invalid SQL data type",
            ),
            ...
            SQLDataType.SQL_SS_UDT: ODBCError(
                ...
                native_error=0,
                return_code=SQLReturn.SQL_ERROR,
                message_text="[Microsoft][ODBC Driver 17 for SQL Server]Optional feature not implemented",
            ),

...
class TestOdbcPsqlA(DriverTest):
    @property
    def expected_sql_get_info_w_return_values(self) -> Mapping[InfoType, Any]:
        return {
            ...
            | SQLConvert.SQL_CVT_BIT
            | SQLConvert.SQL_CVT_BIGINT,
            InfoType.SQL_CONVERT_WCHAR: ODBCError(
                what="SQLGetInfoW",
                sql_state="HYC00",
                native_error=209,
                message_text="Unrecognized key passed to PGAPI_GetInfo.",
            ...
            InfoType.SQL_CONVERT_WLONGVARCHAR: ODBCError(
                what="SQLGetInfoW",
                sql_state="HYC00",
                native_error=209,
                message_text="Unrecognized key passed to PGAPI_GetInfo.",
            ...
            InfoType.SQL_CONVERT_WVARCHAR: ODBCError(
                what="SQLGetInfoW",
                sql_state="HYC00",
                native_error=209,
                message_text="Unrecognized key passed to PGAPI_GetInfo.",
            ...
            InfoType.SQL_DRIVER_NAME: "psqlodbca.so",

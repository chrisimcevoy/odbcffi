...
def driver() -> str:
    return "MySQL ODBC 9.7 Unicode Driver"


class TestMyODBC9w(DriverTest):
    @property
    def expected_sql_get_info_w_return_values(self) -> Mapping[InfoType, Any]:
        return {
            ...
            InfoType.SQL_ASYNC_NOTIFICATION: ODBCError(
                ...
                sql_state="HYC00",
                native_error=4000,
                message_text="[MySQL][ODBC 9.7(w) Driver]Unsupported option: 10025 to SQLGetInfo",
            ...
            InfoType.SQL_CONVERT_GUID: ODBCError(
                ...
                sql_state="HYC00",
                native_error=4000,
                message_text="[MySQL][ODBC 9.7(w) Driver]Unsupported option: 173 to SQLGetInfo",
                return_code=SQLReturn.SQL_ERROR,
            ),
            ...
            InfoType.SQL_DRIVER_AWARE_POOLING_SUPPORTED: ODBCError(
                ...
                sql_state="HYC00",
                native_error=4000,
                message_text="[MySQL][ODBC 9.7(w) Driver]Unsupported option: 10024 to SQLGetInfo",
                return_code=SQLReturn.SQL_ERROR,
            ),

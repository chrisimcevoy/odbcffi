...
def driver() -> str:
    return "MySQL ODBC 26.7 Unicode Driver"


class TestMyODBCW(DriverTest):
    @property
    def expected_sql_get_info_w_return_values(self) -> Mapping[InfoType, Any]:
        return {
            ...
            InfoType.SQL_ASYNC_NOTIFICATION: ODBCError(
                ...
                sql_state="HYC00",
                native_error=4000,
                message_text="[MySQL][ODBC 26.7(w) Driver]Unsupported option: 10025 to SQLGetInfo",
            ...
            InfoType.SQL_COLLATION_SEQ: "utf8mb4_0900_ai_ci",
            ...
            InfoType.SQL_CONVERT_GUID: ODBCError(
                ...
                sql_state="HYC00",
                native_error=4000,
                message_text="[MySQL][ODBC 26.7(w) Driver]Unsupported option: 173 to SQLGetInfo",
                return_code=SQLReturn.SQL_ERROR,
            ),
            ...
            InfoType.SQL_DRIVER_AWARE_POOLING_SUPPORTED: ODBCError(
                ...
                sql_state="HYC00",
                native_error=4000,
                message_text="[MySQL][ODBC 26.7(w) Driver]Unsupported option: 10024 to SQLGetInfo",
                return_code=SQLReturn.SQL_ERROR,
            ),
